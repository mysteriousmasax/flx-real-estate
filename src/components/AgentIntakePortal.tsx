          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                {user ? (
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="text-xs font-bold text-white">Agent Access</div>
                      <div className="text-[10px] text-zinc-400">Sign in to begin property intake and verification</div>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="p-4 rounded-xl bg-[#0f1115] border border-white/10">
              <label className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2 mb-3">
                ...
                <span>Cinematic Video Tour (Local Device Preview)</span>
              </label>
