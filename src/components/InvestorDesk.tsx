  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8 space-y-6">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <ToolCard title="Deal scanner" text="Surface high-yield opportunities and compare cap rates quickly." icon={<TrendingUp className="w-4 h-4" />} accent="emerald" />
        <ToolCard title="Risk review" text="Review asset metrics, pricing, and occupancy before making an offer." icon={<ShieldCheck className="w-4 h-4" />} accent="blue" />
        <ToolCard title="Watchlist" text="Track favorite assets and build a synthetic pipeline from local market activity." icon={<ArrowUpRight className="w-4 h-4" />} accent="red" />
      </section>
